...
<html>
    ...
    <div class="container box mt-4">
                        ...
                        <?php if (isLoggedIn()): ?>
                            <br><p >Bem vindo, <?php echo $_SESSION['user_name']; ?>. 
                            <div>
                            <a class="btn btn-outline-primary" href="panel.php">Painel</a> 
                            <a class="btn btn-outline-danger" href="logout.php">Sair</a>
                            </div>
                            </p>
                        <?php else: ?>
                            <a  id="bt" class="btn btn-light float-end" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"> LOGIN </a>
                        <?php endif; ?>
        </div>
    </div>
<!-- modal login -->
